...
namespace Proxies\__CG__\Bash\NodesBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Quote extends \Bash\NodesBundle\Entity\Quote implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'subject', 'author', 'path', 'image', 'file', 'created', 'comments');
        }
     ...
     * {@inheritDoc}
     */
    public function addComment(\Bash\NodesBundle\Entity\Comment $comment)
    {
